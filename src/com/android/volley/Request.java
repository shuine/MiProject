...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    /** Listener interface for all state. */
    ...
    private boolean mShouldHttps = true;
     ...
     * 
     * @deprecated Use
     *             {@link #Request(int, String, com.android.volley.Response.Listener)}
     *             .
     */
    @Deprecated
    ...
    /**
     * @return this request's {@link com.android.volley.Response.Listener}.
     */
    ...
    public Request<?> setRequestQueue(RequestQueue requestQueue) {
        ...
        mQueuedTime = SystemClock.elapsedRealtime();
        return this;
    }
    ...
    public final Request<?> setShouldHttps(boolean shouldHttps) {
        mShouldHttps = shouldHttps;
        return this;
    }
