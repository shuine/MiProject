...
public class BasicNetwork implements Network {
    ...
    public NetworkResponse performRequest(Request<?> request) throws VolleyError {
        ...
        long requestSendedTime = SystemClock.elapsedRealtime();
        while (true) {
            ...
            try {
                ...
                requestSendedTime = SystemClock.elapsedRealtime();
                ...
                if (statusCode == HttpStatus.SC_NOT_MODIFIED) {
                    ...
                    if (entry == null) {
                        return new NetworkResponse(HttpStatus.SC_NOT_MODIFIED, null,
                                ...
                                (int) (SystemClock.elapsedRealtime() - requestStart),
                                (int) (requestSendedTime - requestStart),
                                0,
                                timestamp);
                    }
                ...
                return new NetworkResponse(statusCode, responseContents, responseHeaders, false,
                        (int) (SystemClock.elapsedRealtime() - requestStart),
                        (int) (requestSendedTime - requestStart),
                        (int) (SystemClock.elapsedRealtime() - requestSendedTime),
                        timestamp);
     ...
     */
    protected Map<String, String> convertHeaders(String url, Header[] headers) {
        Map<String, String> result = new TreeMap<String, String>(String.CASE_INSENSITIVE_ORDER);
        for (int i = 0; i < headers.length; i++) {
            result.put(headers[i].getName(), headers[i].getValue());
        }

        final String uuid = result.get("Uuid");
        if (!TextUtils.isEmpty(uuid)) {
            /*PreferenceUtil.setStringPref(ShopApp.instance,
                    Constants.Preference.PREF_KEY_HEADER_UUID, uuid);*/
        }
        return result;
    }
}
